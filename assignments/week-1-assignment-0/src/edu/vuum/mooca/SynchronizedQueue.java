   ...
   public enum SynchronizedQueueResult {
    ...
    public static SynchronizedQueueResult testQueue(QueueAdapter<Integer> queue) {
        try {
            ...
            // TODO +DONE - you fill in here to replace the null
            ...
            // TODO +DONE- you fill in here to start the threads. More
            ...
            // TODO +DONE- you fill in here to interrupt the threads.
            consumer.interrupt();
            producer.interrupt();

            // TODO +DONE- you fill in here to wait for the threads to
            // exit.
            consumer.join();
            producer.join();            
